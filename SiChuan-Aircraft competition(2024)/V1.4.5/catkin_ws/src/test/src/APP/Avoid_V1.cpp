...
int main(int argc, char** argv) 
{
    ...
    auto Get_Cloud_Close = [&](const test::cloud_date::ConstPtr& msg)
    {
        ...
        pos_line = Get_Close_Position_Line(cloud_date.x, cloud_date.y, now_position.x, now_position.y, obs_angle, safety_radius*1.5);
        pos_ver = Get_Close_Position_Vertical(pos_line.first, pos_line.second, set_position.x, set_position.y, obs_angle, run_len*1.5);
